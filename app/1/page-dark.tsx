    ...
    return (
      <div className="bg-gray-900/90 dark:bg-gray-950/90 backdrop-blur-sm rounded-3xl p-8 border border-amber-400/30 dark:border-amber-500/30 shadow-2xl shadow-amber-500/10">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="ml-2 text-sm text-gray-400 font-mono">scrint.dev/room/H7J9M1</span>
    ...
    <>
      ...
      <nav className="relative z-10 flex items-center justify-between p-6 max-w-7xl mx-auto">
        <div className="flex items-center gap-3">
          ...
          />
          <span className="font-bold text-xl text-white">Scrint.dev</span>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              />
              <span className="font-semibold text-white">Scrint.dev</span>
            </div>
